...
Meter Rent[MR] 30.00
f) Total Amt.(Bill#5670000000001) (a+b+c+e) 1307.00
"""

SAMPLE_MONTHLY_TOD_SPLIT_LAYOUT = """
Consumer# 1150000000002
Bill# 5645000000002
Bill Date 02-09-2025 Due Date 12-09-2025
Meter# VTKM00000000000002
Zone
Normal
Normal
Off Peak
...
1 / 2
Total Amt.(Bill#5645000000002) (a+b+c+e) 1217.00
"""
...
Electricity Duty[ED]
Meter Rent[MR]
Total Amt.(Bill#5547000000004)          (a+b+c+e)
3494.03
347.36
12.00
4293.00
...
def test_parse_cumulative_import_format(monkeypatch):
    ...
    assert parsed["bill_number"] == "5670000000001"
...
def test_parse_cumulative_import_format_decimal_units(monkeypatch):
    ...
    assert parsed["bill_number"] == "5670000000003"
...
def test_parse_monthly_tod_split_layout(monkeypatch):
    ...
    assert parsed["bill_number"] == "5645000000002"
...
def test_parse_tod_split_layout_import_only(monkeypatch):
    ...
    assert parsed["bill_number"] == "5547000000004"
